                  ...
                  <div className="mt-auto space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-2 pt-4">
                      <a 
                        ...
                        className="flex items-center justify-center gap-2 bg-gray-900 text-white py-3 rounded-sm font-bold text-xs hover:bg-black transition-all"
                      >
                        <Phone size={14} />
                        ARA
                      </a>
                      <a 
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-center gap-2 bg-[#25D366] text-white py-3 rounded-sm font-bold text-xs hover:bg-[#128C7E] transition-all"
                      >
